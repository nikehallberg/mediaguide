    ...
    <nav>
      <div className='navbar-header'>
        <NavLink to='/'>
          <img
            className='logo'
            src={isDark ? Logo3 : Logo}
            alt='Media Guide logo'
          />
        </NavLink>
        <button
        ...
        >
          {isDark ? (
            ...
            >
              <path
                d='M12 4.5V2m0 20v-2.5M4.5 12H2m20 0h-2.5M5.6 5.6L4 4m16 16l-1.6-1.6M18.4 5.6L20 4M4 20l1.6-1.6M12 8a4 4 0 100 8 4 4 0 000-8z'
                stroke='currentColor'
                strokeWidth='1.2'
                strokeLinecap='round'
        ...
        >
          ...
          <ul className={menuOpen ? "nav-open" : ""}>
            ...
            <li>
              <NavLink to='/shows' onClick={() => setMenuOpen(false)}>
                Shows
              </NavLink>
            </li>
            <li>
              <NavLink to='/songs' onClick={() => setMenuOpen(false)}>
                Songs
              </NavLink>
            </li>
            <li>
