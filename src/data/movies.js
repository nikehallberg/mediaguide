// Helper to dynamically import movie images
const movieImage = (num, ext = 'jpg') => {
    // Some images have different extensions
    const extMap = {
        8: 'png', 9: 'png', 14: 'png', 15: 'jpeg', 17: 'png', 18: 'jpeg', 26: 'png'
    };
    const realExt = extMap[num] || ext;
    return new URL(`../assets/movie${num}.${realExt}`, import.meta.url).href;
};
